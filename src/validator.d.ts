...
export declare class RegExpValidator {
    ...
    private onLiteralEnter(start);
    private onLiteralLeave(start, end);
    private onFlags(start, end, global, ignoreCase, multiline, unicode, sticky, dotAll);
    private onPatternEnter(start);
    private onPatternLeave(start, end);
    private onDisjunctionEnter(start);
    private onDisjunctionLeave(start, end);
    private onAlternativeEnter(start, index);
    private onAlternativeLeave(start, end, index);
    private onGroupEnter(start);
    private onGroupLeave(start, end);
    private onCapturingGroupEnter(start, name);
    private onCapturingGroupLeave(start, end, name);
    private onQuantifier(start, end, min, max, greedy);
    private onLookaroundAssertionEnter(start, kind, negate);
    private onLookaroundAssertionLeave(start, end, kind, negate);
    private onEdgeAssertion(start, end, kind);
    private onWordBoundaryAssertion(start, end, kind, negate);
    private onAnyCharacterSet(start, end, kind);
    private onEscapeCharacterSet(start, end, kind, negate);
    private onUnicodePropertyCharacterSet(start, end, kind, key, value, negate);
    private onCharacter(start, end, value);
    private onBackreference(start, end, ref);
    private onCharacterClassEnter(start, negate);
    private onCharacterClassLeave(start, end, negate);
    private onCharacterClassRange(start, end, min, max);
    ...
    private reset(source, start, end);
    private rewind(index);
    private advance();
    private eat(cp);
    private eat2(cp1, cp2);
    private eat3(cp1, cp2, cp3);
    private raise(message);
    ...
    private eatQuantifier(noError?);
    private eatBracedQuantifier(noError);
    private eatAtom();
    private eatDot();
    ...
    private isValidIdentityEscape(cp);
    ...
    private eatFixedHexDigits(length);
}
