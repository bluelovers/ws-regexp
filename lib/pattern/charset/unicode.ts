...
//	...CACHE_BLOCKS,
	...
	...CACHE_PROPERTY_DATA.$LONE,
	...CACHE_PROPERTY_DATA.General_Category,

	...UNICODE,
};

export enum UNICODE_NAME_ALIAS
{
...
export const UNICODE_NAME_ALIAS_ALL = Object.assign({}, NAME_ALIAS, UNICODE_NAME_ALIAS, NAME_ALIAS);
...
{
	if (!PatternTest.hasOwnProperty(name) && UNICODE_NAME_ALIAS_ALL[name] && PatternTest.hasOwnProperty(UNICODE_NAME_ALIAS_ALL[name]))
	{
		name = UNICODE_NAME_ALIAS_ALL[name];
	}
