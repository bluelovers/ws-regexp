 ...
 */
export function toRegex(root: State, flags: string): string
{
 ...
 */
export function union(a, b): Repetition | CharClass | Alternation | Concatenation
{
	if (a != null && b != null && a !== b)
	{
		// Hoist common substrings at the start and end of the options
		let start: string, end: string, res: Repetition | CharClass | Alternation | Concatenation;
 ...
 */
export function removeCommonSubstring(a: Literal | Concatenation, b: Literal | Concatenation, side: 'start' | 'end'): [Literal | Concatenation, Literal | Concatenation, string]
{
 ...
 */
export function commonSubstring(a, b, side?: 'start' | 'end')
{
 ...
 */
export function concat(a: Literal, b: Literal)
{
	if (a == null || b == null)
	{
		return null;
