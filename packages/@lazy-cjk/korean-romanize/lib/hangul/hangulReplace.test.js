...
const hangulReplace_1 = require("./hangulReplace");
const testCases = [
    {
...
describe("hangul replacer", () => {
    testCases.forEach(({ text, hangulWords }) => {
        test(`should find [${hangulWords.join(", ")}] in "${text}"`, () => {
            ...
            (0, hangulReplace_1.hangulReplace)(text, mockCallback);
    ...
    test(`should find nothing in a given Japanese sentence`, () => {
        ...
        const mockCallback = jest.fn();
        (0, hangulReplace_1.hangulReplace)(nara, mockCallback);
    ...
    test(`should find nothing in a given English sentence`, () => {
        ...
        const mockCallback = jest.fn();
        (0, hangulReplace_1.hangulReplace)(seoJaePil, mockCallback);
        expect(mockCallback).not.toHaveBeenCalled();
    });
});
