...
import { table_tw2cn, table_cn2tw } from '@lazy-cjk/zh-convert-table';
import {
	table_tw2cn_plus,
	table_cn2tw_plus,
	table_tw2cn_min_plus,
	table_cn2tw_min_plus,
} from '@lazy-cjk/zh-convert-table/table_plus';
import { SAFE_MODE_CHAR_MIN } from '@lazy-cjk/zh-convert/lib/min/const';
import { toStrTableArray } from '@lazy-cjk/util/strtable';
import fs from 'fs-extra';

let build_path = path.join(__dirname, '../../data');
