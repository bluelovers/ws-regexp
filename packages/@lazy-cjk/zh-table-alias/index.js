...
function jp(char, options = {}) {
    let a = [];
    a = core_1._get(a, table_1.table_jp[char]);
    return a;
}
exports.jp = jp;
function tw(char, options = {}) {
    let a = [];
    a = core_1._get(a, raw_1._table_tw[char], zh_convert_1.cn2tw(char, options));
...
function cn(char, options = {}) {
    let a = [];
    a = core_1._get(a, table_1._table_cn[char], zh_convert_1.tw2cn(char, options));
